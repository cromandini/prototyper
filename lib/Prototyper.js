...
var Prototyper = module.exports = {
    ...
    create: function create() {
        ...
        instance = Object.create(this, {
            ...
            callSuper: {
                value: function (fn) {
                    var theSuper = this.isInstance ? this.super.super : this.super;
                    return {
                        withParams: theSuper[ fn ].bind(this)
                    };
                }
            }
        });
        ...
        while (theClass !== Prototyper) {
            utils.mixProperties(instance, theClass.iVars, { override: true, define: true });
